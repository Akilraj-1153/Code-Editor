    ...
    <div className="h-fit w-full flex flex-col gap-2">
      <div className="h-[7vh] w-screen bg-stone-900 rounded-b-lg flex items-center">
        ...
        <div className="flex gap-2 justify-end h-full w-full items-center mr-10 font-mateSc text-xl select-none xs:hidden md:flex">
          <Link to='/' className="text-black font-bold bg-white rounded-md p-2 scale-75 hover:scale-100 transition-transform ">
            Home
          </Link>
          <Link to='code_editor' className="text-black font-bold bg-white rounded-md p-2  scale-75 hover:scale-100 transition-transform ">
            Code Editor
          </Link>
          <Link to='about' className="text-black font-bold bg-white rounded-md p-2  scale-75 hover:scale-100 transition-transform ">
            About
          </Link>
        </div>
