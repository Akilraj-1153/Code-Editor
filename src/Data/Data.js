...
export const languageOptions = [
  ...
  { language: "javascript", version: "18.15.0", runtime: "node", code: `console.log("Hello, World!");` },
  { language: "typescript", version: "5.0.3", code: `console.log("Hello, World!");` },
  { language: "java", version: "15.0.2", code: `public class HelloWorld { public static void main(String[] args) { System.out.println("Hello, World!"); } }` },
  { language: "c", version: "10.2.0", runtime: "gcc", code: `#include <stdio.h>\nint main() { printf("Hello, World!\\n"); return 0; }` },
  { language: "c++", version: "10.2.0", runtime: "gcc", code: `#include <iostream>\nint main() { std::cout << "Hello, World!" << std::endl; return 0; }` },
  { language: "ruby", version: "3.0.1", code: `puts 'Hello, World!'` },
  { language: "php", version: "8.2.3", code: `<?php echo 'Hello, World!'; ?>` },
  { language: "go", version: "1.16.2", code: `package main\nimport "fmt"\nfunc main() { fmt.Println("Hello, World!") }` },
  { language: "swift", version: "5.3.3", code: `print("Hello, World!")` },
  { language: "rust", version: "1.68.2", code: `fn main() { println!("Hello, World!"); }` },
  { language: "kotlin", version: "1.8.20", code: `fun main() { println("Hello, World!") }` },
  ...
  { language: "typescript", version: "1.32.3", runtime: "deno", code: `console.log("Hello, World!");` },
  { language: "python2", version: "2.7.18", code: `print "Hello, World!"` },
  { language: "bash", version: "5.2.0", code: `echo "Hello, World!"` },
  { language: "csharp", version: "6.12.0", runtime: "mono", code: `using System; class Program { static void Main() { Console.WriteLine("Hello, World!"); } }` },
  { language: "basic", version: "6.12.0", runtime: "mono", code: `PRINT "Hello, World!"` },
  { language: "shell", version: "0.5.11", code: `echo "Hello, World!"` },
  { language: "dart", version: "2.19.6", code: `void main() { print('Hello, World!'); }` },
  { language: "haskell", version: "9.0.1", code: `main = putStrLn "Hello, World!"` },
  { language: "scala", version: "3.2.2", code: `@main def hello() = println("Hello, World!")` },
  { language: "elixir", version: "1.11.3", code: `IO.puts "Hello, World!"` },
  { language: "fsharp.net", version: "5.0.201", runtime: "dotnet", code: `printfn "Hello, World!"` },
  { language: "csharp.net", version: "5.0.201", runtime: "dotnet", code: `using System; class Program { static void Main() { Console.WriteLine("Hello, World!"); } }` },
  { language: "erlang", version: "23.0.0", code: `io:format("Hello, World!\\n").` },
  { language: "fortran", version: "10.2.0", runtime: "gcc", code: `program hello\nprint *, "Hello, World!"\nend program hello` },
  ...
  { language: "pascal", version: "3.2.2", code: `program HelloWorld; begin writeln('Hello, World!'); end.` },
  { language: "awk", version: "5.1.0", runtime: "gawk", code: `BEGIN { print "Hello, World!" }` },
  { language: "matl", version: "22.7.4", code: `disp('Hello, World!')` },
  { language: "japt", version: "2.0.0", code: `⎚"Hello, World!"` },
  { language: "racket", version: "8.3.0", code: `#lang racket\n"Hello, World!"` },
  { language: "raku", version: "6.100.0", code: `say 'Hello, World!';` },
  { language: "powershell", version: "7.1.4", runtime: "pwsh", code: `Write-Output "Hello, World!"` },
  { language: "fsharp", version: "5.0.201", runtime: "dotnet", code: `printfn "Hello, World!"` },
  { language: "sqlite3", version: "3.36.0", code: `SELECT 'Hello, World!';` },
  { language: "smalltalk", version: "3.2.3", code: `Transcript show: 'Hello, World!'.` },
  { language: "coffeescript", version: "2.5.1", code: `console.log 'Hello, World!'` },
  { language: "jelly", version: "0.1.31", code: `“Hello, World!”` },
  { language: "llvm_ir", version: "12.0.1", code: `@.str = private constant [13 x i8] c"Hello, World!\\00", align 1\ndefine i32 @main() #0 {\n  %1 = call i32 @printf(i8* getelementptr inbounds ([13 x i8], [13 x i8]* @.str, i64 0, i64 0))\n  ret i32 0\n}\ndeclare i32 @printf(i8*, ...) #1` },
  { language: "basic.net", version: "5.0.201", runtime: "dotnet", code: `Module HelloWorld\nSub Main()\nConsole.WriteLine("Hello, World!")\nEnd Sub\nEnd Module` },
  { language: "fsi", version: "5.0.201", runtime: "dotnet", code: `printfn "Hello, World!"` },
  { language: "d", version: "10.2.0", runtime: "gcc", code: `import std.stdio; void main() { writeln("Hello, World!"); }` },
  { language: "brachylog", version: "1.0.0", code: `writeln("Hello, World!")` },
  { language: "brainfuck", version: "2.7.3", code: `++++++++++[>+++++++>++++++++++>+++>+<<<<-]>++.>+.+++++++..+++.>++.<<+++++++++++++.>++++.------------.---.>+.>++.` },
  { language: "cjam", version: "0.6.5", code: `"Hello, World!"` },
  { language: "cobol", version: "3.1.2", code: `IDENTIFICATION DIVISION.\nPROGRAM-ID. HelloWorld.\nPROCEDURE DIVISION.\nDISPLAY 'Hello, World!'.\nSTOP RUN.` },
  { language: "crystal", version: "0.36.1", code: `puts "Hello, World!"` },
  { language: "dragon", version: "1.9.8", code: `print("Hello, World!")` },
  { language: "emojicode", version: "1.0.2", code: `🍇🍉\n🍴 🍇 🍉\n😀 🍦 🔤Hello, World!🔤 🍉` },
  ...
  { language: "husk", version: "1.0.0", code: `main = putStrLn "Hello, World!"` },
  { language: "iverilog", version: "11.0.0", code: `module main;\ninitial begin\n  $display("Hello, World!");\n  $finish;\nend\nendmodule` },
  { language: "lisp", version: "2.1.2", code: `(print "Hello, World!")` },
  { language: "lolcode", version: "0.11.2", code: `HAI 1.2\nVISIBLE "Hello, World!"\nKTHXBYE` },
  { language: "osabie", version: "1.0.1", code: `print("Hello, World!")` },
  { language: "paradoc", version: "0.6.0", code: `print("Hello, World!")` },
  { language: "ponylang", version: "0.39.0", code: `actor Main\n  new create(env: Env) => env.out.print("Hello, World!")` },
  { language: "prolog", version: "8.2.4", code: `:- initialization(main).\nmain :- write('Hello, World!'), nl.` },
  ...
  { language: "vlang", version: "0.3.3", code: `fn main() {\n println('Hello, World!')\n}` },
  { language: "vyxal", version: "2.4.1", code: `print("Hello, World!")` },
  { language: "yeethon", version: "3.10.0", code: `print("Hello, World!")` },
  { language: "zig", version: "0.10.1", code: `const std = @import("std");\npub fn main() void {\n  std.debug.print("Hello, World!\\n", .{});\n}` },
  { language: "nasm", version: "2.15.5", runtime: "nasm", code: `section .data\nhello db 'Hello, World!', 0\nsection .text\nglobal _start\n_start:\nmov edx, len\nmov ecx, hello\nmov ebx, 1\nmov eax, 4\nint 0x80\nmov eax, 1\nint 0x80\nlen equ $ - hello` },
  { language: "nasm64", version: "2.15.5", runtime: "nasm", code: `section .data\nhello db 'Hello, World!', 0\nsection .text\nglobal _start\n_start:\nmov edx, len\nmov ecx, hello\nmov ebx, 1\nmov eax, 4\nint 0x80\nmov eax, 1\nint 0x80\nlen equ $ - hello` },
  { language: "ocaml", version: "4.12.0", code: `print_endline "Hello, World!"` }
];
